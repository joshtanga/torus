...
<script>
    ...
    function updateVisualization() {
        ...
        if (currentData) {
            ...
            // 2. Update the Histogram Image
            const histImg = document.querySelector('#hist-scrubber');
            histImg.src = `../assets/torus_plots/dist_plot_${idx}.png`;
    
            // 3. THE QUICK FIX: Update the text spans
            // In manifest.csv, 'r' usually corresponds to Major and 'major_radius' to Minor 
            // because of how R's clean_names() handles the columns.
            document.querySelector('#val-R').innerText = currentData.r.toFixed(2);
            document.querySelector('#val-r').innerText = currentData.major_radius.toFixed(2);
