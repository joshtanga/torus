...
Since you are varying the Minor Radius ($r$), the total surface area of the torus changes significantly ($Area = 4\pi^2 R r$).

In your histograms, the "Ratio" will likely shift entirely to the right (all faces getting larger) as you increase $r$. This is a great way to show the difference between a Conformal map (which preserves angles) and an Equiareal map (which preserves area). Your sweep is neither, so the "drift" of the histogram away from 1.0 perfectly quantifies how much the geometry is stretching!
...
<div style="margin-top: 20px;"><label><strong>Major Radius (R):</strong></label><input type="range" id="slider-R" min="0" max="10" value="0" style="width: 100%;">

<label><strong>Minor Radius (r):</strong></label><input type="range" id="slider-r" min="0" max="10" value="0" style="width: 100%;"></div>
