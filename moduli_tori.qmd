...
<div style="margin-top: 20px;"><label><strong>Major Radius (R):</strong></label><input type="range" id="slider-R" min="0" max="10" value="0" step="1" style="width: 100%;">
<label><strong>Minor Radius (r):</strong></label><input type="range" id="slider-r" min="0" max="10" value="0" step="1" style="width: 100%;"></div>
