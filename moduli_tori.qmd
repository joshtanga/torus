...
<model-viewer 
    id="torus-scrubber" 
    src="../assets/torus_radii_sweep/step_0.glb"
    camera-controls 
    style="width: 100%; height: 400px;">
</model-viewer>

<input type="range" id="master-slider" min="0" max="19" value="0" style="width: 100%;">
<p><strong>Slide to change modulus:</strong> <span id="frame-val">0</span></p>
</div>
...
<div style="flex: 1; min-width: 300px; text-align: center;">
  <img id="hist-scrubber" src="../moduli_hist/histogram_0.png" style="width: 100%; max-width: 450px; border-radius: 8px;">
</div>
:::
:::
...
orig_areas <- read_csv('moduli_hist/og_areas.csv') |> janitor::clean_names()
face_data <- read_csv("moduli_hist/ratios.csv") |> janitor::clean_names()
...
<script>
    ...
    slider.addEventListener('input', (e) => {
        ...
        // Update 3D Model
        viewer.src = `../assets/torus_radii_sweep/step_${val}.glb`;
        
        // Update Histogram Image
        histImg.src = `../moduli_hist/histogram_${val}.png`;
