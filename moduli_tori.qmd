...
<div style="margin-top: 20px;"><label><strong>Major Radius (R):</strong></label><input type="range" id="slider-R" min="5" max="15" value="5" step="2.5"style="width: 100%;">
<label><strong>Minor Radius (r):</strong></label><input type="range" id="slider-r" min="1" max="5" value="1" style="width: 100%;"></div>
