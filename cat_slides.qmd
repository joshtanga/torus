...
- documentarty [secrets of the surface](https://www.zalafilms.com/secrets/production.html): screening @ NMU Fall, 2026.  

![](assets/secret_movie.png){width=50%}
...
Henri Poincar&eacute;, **born April 29, 1854** 
...
<!-- https://www.ams.org/publications/journals/notices/201711/rnoti-p1313.pdf -->
...
# [Arnold's Cat Map]{style="font-size: 0.9em;"} {.left background-image="assets/arnold_cat_fig.png" background-size="contain" background-position="right"}
...
# Trace Trichotomy {.center background-image="assets/conic2_rotated.png" background-size="30%" background-position="right" background-opacity=0.5}

:::: {.columns}

::: {.column width="70%" style="text-align=center;"}

![](assets/trichotomy.png){height="275px" fig-align="center"}
...
<center>The Cat Map is Anosov</center>

:::

::::

# {.center background-image="assets/eigen_catmap.png" background-size="contain" background-position="center"}

# {.center background-image="assets/computation.png" background-size="50%" background-position="right"}
...
# {.center background-image="assets/eigen_golden.png" background-size="40%" background-position="right"}
...
::: {.column width="40%"}
![](assets/computation.png){width="100%"}
:::
...
# {background-iframe="https://joshtanga.github.io/torus/dehn_twist/"  background-interactive=true}

---

### Periodic Mappings on the Torus

# {background-iframe="https://joshtanga.github.io/torus/periodic/"  background-interactive=true}

---

### Deformations of the Geometry of the Torus

The mapping seen heretofore are all <u>mapping classes</u>.  

# {background-iframe="https://joshtanga.github.io/torus/docs/geometry_changes.html"  background-interactive=true}

### Moduli of Tori

# {background-iframe="https://joshtanga.github.io/torus/docs/moduli_tori.html"  background-interactive=true}
...
1. Slides/Code + : ![qr-code](assets/qr_code_cat_slides.png){width=100px}  and [https://joshtanga.github.io/torus/](https://joshtanga.github.io/torus/)
2. Math: Primer on Mapping Class Groups by Farb & Margalit
3. Software/Toools: Python/R + Open3D, Quarto/Markdown + RevealJS
