...
<div style="flex: 1; min-width: 300px; text-align: center;">
  <img id="hist-scrubber" src="../assets/torus_area_analysis/hist_0.png" style="width: 100%; max-width: 450px; border-radius: 8px;">
</div>
...
<script>
    ...
    slider.addEventListener('input', (e) => {
        ...
        histImg.src = '../assets/torus_area_analysis/hist_${val}.png';
...
<script>
    ...
    slider.addEventListener('input', (e) => {
        viewer.src = `../assets/torus_area_analysis/step_${e.target.value}.glb`;
    });
</script>
